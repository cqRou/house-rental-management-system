   ...
   <div class="apply-and-evaluation clearfix"> 
    <div class="reward-evaluation"> 
     <div class="evaluation-group"> 
      <img class="evaluation-item rmb" :src="rmb"/> 钱太少 <span class="evaluation-count">7</span> 
      <img class="evaluation-item clock" :src="clock"/> 时间紧 <span class="evaluation-count">0 </span> 
      <img class="evaluation-item hand" :src="hand"/> 不靠谱 <span class="evaluation-count">5</span> 
      <img class="evaluation-item frown":src="frown"> 不会做 <span class="evaluation-count">0</span> 
     </div> 
    </div> 
